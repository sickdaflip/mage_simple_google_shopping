...
var CodeMirror = (function () {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        var instance = wrapper.CodeMirror = {
            ...
            setOption: function (option, value) {
                ...
                if (option == "lineNumbers" || option == "gutter" || option == "firstLineNumber")
                    ...
                    scroller.className = scroller.className.replace(/cm-s-\w+/, "cm-s-" + value);
            },
        ...
        function setValue(code) {
            ...
            var top = {line: 0, ch: 0};
            updateLines(
                    top, {line: lines.length - 1, ch: lines[lines.length - 1].text.length},
        ...
        function onMouseDown(e) {
            ...
            var move = connect(
                    targetDocument, "mousemove", operation(
                            function (e) {
                                clearTimeout(going);
                                e_preventDefault(e);
                                extend(e);
            ...
            var up = connect(
                    targetDocument, "mouseup", operation(
                            function (e) {
                                clearTimeout(going);
        ...
        function onKeyPress(e) {
            ...
            if (code == 13) {
                if (!options.readOnly)
                    handleEnter();
                e_preventDefault(e);
            } else if (!e.ctrlKey && !e.altKey && !e.metaKey && code == 9 && options.tabMode != "default")
                e_preventDefault(e);
            else
                fastPoll(curKeyId);
        }
        ...
        function replaceSelection(code, collapse) {
            replaceRange1(
                    splitLines(code), sel.from, sel.to, function (end) {
                if (collapse == "end")
        ...
        function updateDisplay(changes) {
            ...
            if (lineDiv.childNodes.length != showingTo - showingFrom)
                throw new Error(
                        "BAD PATCH! " + JSON.stringify(updates) + " size=" + (showingTo - showingFrom) +
        ...
        function getStateBefore(n) {
            ...
            if (n < lines.length && !lines[n].stateAfter)
                work.push(n);
            return state;
        }
